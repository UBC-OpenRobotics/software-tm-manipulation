"""Initialize the :humble-gazebo-gym:`humble_gazebo_gym <>` package.

.. important::

    Here all the all :humble-gazebo-gym:`humble_gazebo_gym <>` task environments are
    registered so that they are available in the gymnasium namespace.
"""

from gymnasium.envs.registration import register
from humble_gazebo_gym.task_envs.task_envs_list import ENVS
